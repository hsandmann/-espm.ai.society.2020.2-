...
|     27 | **Prova Final** | Apresentação: <br> - Caso de uso ou projeto (produto) onde o ponto essencial seja Machine Learning <br> - Estimar técnicas de Machine Learning aplicáveis ao problema <br> - Implementação (bônus) |
| dez.04 | Substitutivas | |
